  ...
  return (
    <div id="corporate_floating_help_desk" className="fixed bottom-6 right-6 z-50 flex flex-col items-end space-y-3 font-sans">
      ...
      <div className="floating-action-stack flex flex-col items-center gap-2.5">
        ...
        <a 
          href="https://wa.me/971526692157?text=Hello%20Scale%20Partners%20Advisory%20Desk.%20I%20would%20like%20to%20enquire%20about%20starting%20a%20company%20in%20Dubai."
          target="_blank"
