      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start border-b border-zinc-100 pb-16 mb-16 relative z-10">
          <div className="lg:col-span-7 space-y-4 font-sans">
            ...
            {/* Author Credit */}
            <div className="flex items-center space-x-3 pt-3 border-t border-zinc-100/80 max-w-lg">
              <div className="w-10 h-10 rounded-full overflow-hidden shrink-0 shadow-md border border-zinc-200 relative">
                <Image 
                  src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=200&auto=format&fit=crop"
                  alt="Amina Al-Mansoor Portrait"
                  fill
                  sizes="40px"
                  className="object-cover"
                />
              </div>
              <div className="text-[11.5px] text-zinc-500 font-sans flex items-center flex-wrap gap-[5px]">
                <span>Corporate setup by senior associate</span>
                <span className="font-bold text-zinc-800">Amina Al-Mansoor</span>
                <span className="text-zinc-300">•</span>
                <span className="text-zinc-500 text-[11px]">LL.M., Sovereign Registry Advisory Desk</span>
              </div>
            </div>
