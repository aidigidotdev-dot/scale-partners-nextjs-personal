    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="rounded-2xl overflow-hidden border border-zinc-200/50 shadow-sm h-[200px] mt-6 relative group">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0B2E16]/90 to-transparent p-4 flex items-end justify-between z-10">
                <span className="w-fit inline-block px-2.5 py-0.5 rounded-md bg-white/10 backdrop-blur-xs text-[10px] font-mono uppercase tracking-wider text-white border border-white/10 shadow-3xs">{current.image1Label}</span>
        ...
        <div className="mb-20 rounded-2xl overflow-hidden border border-zinc-200/50 shadow-sm h-[200px] relative group z-10">
          ...
          />
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0B2E16]/90 to-transparent p-4 flex items-end justify-between z-10">
            <span className="w-fit inline-block px-2.5 py-0.5 rounded-md bg-white/10 backdrop-blur-xs text-[10px] font-mono uppercase tracking-wider text-white border border-white/10 shadow-3xs">{current.image2Label}</span>
        ...
        <div className="mb-20 rounded-2xl overflow-hidden border border-zinc-200/50 shadow-md h-[260px] relative group z-10">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#0B2E16]/95 via-[#08854C]/35 to-transparent flex flex-col justify-end p-6 sm:p-8 z-10">
            <span className="w-fit inline-block px-2.5 py-0.5 rounded-md bg-white/10 backdrop-blur-xs text-[10px] font-mono uppercase tracking-[0.2em] text-white border border-white/10 mb-1.5 shadow-3xs">{current.image3Label}</span>
